                ...
                >
                  ...
                  <CardContent>
                    <div className="grid grid-cols-2 gap-4 mb-6">
                        <div>
                            <p className="text-sm text-slate-500 dark:text-slate-400 mb-0.5">Students</p>
                            <p className="text-2xl font-bold">{course.students}</p>
                        </div>
                        <div>
                            <p className="text-sm text-slate-500 dark:text-slate-400 mb-0.5">Modules</p>
          ...
          <TabsContent value="students" className="mt-0">
            <Card className="rounded-2xl border-dashed border-2 border-slate-200 dark:border-slate-800 bg-transparent shadow-none p-12">
              <div className="text-center text-slate-500 flex flex-col items-center">
                ...
                <p className="text-sm">
                  Select a specific course above to view detailed performance metrics.
                </p>
              </div>
            </Card>
          </TabsContent>
