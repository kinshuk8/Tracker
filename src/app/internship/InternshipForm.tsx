...
interface CourseOption {
    id: string; // Use slug or string ID
    label: string;
}
...
export default function InternshipForm({ initialCourses }: InternshipFormProps) {
    ...
    // Combine DB courses with "Other" option if needed, or just append "Other" in the mapped array passed as prop
    // Ideally, "Other" is a static option we always want.
    const courseOptions = [
        ...initialCourses,
