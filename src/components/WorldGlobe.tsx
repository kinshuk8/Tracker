...
export default function WorldGlobe() {
    return (
        <div className="flex flex-col items-center justify-center py-20 dark:bg-black bg-white relative w-full">
            <div className="max-w-7xl mx-auto w-full px-4">
                ...
                {/* Globe Container */}
                <div className="relative overflow-visible h-[500px] md:h-[600px]">
